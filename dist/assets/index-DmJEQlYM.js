...
const B = {
  ...
  G = { ariaLabel: { type: String }, ariaDescribedby: { type: String } },
  H = { type: { type: String, required: !0 }, ...B, ...G },
  J =
    U[0] === "2"
        ...
        (r, b) => {
          ...
          if (p) {
            const l = u(p.labels),
              ...
              P = u(p.datasets),
              R = u(g.datasets);
            l !== x && (S(i.config.data, l), (h = !0)),
              P && P !== R && (I(i.config.data, P, t.datasetIdKey), (h = !0));
          }
          h &&
            F(() => {
              M(i);
  ...
  return (
    ...
    O({
      ...
      setup(s, o) {
        ...
        return n({ chart: a }), () => m(W, J({ ref: c }, { type: t, ...s }));
      },
    })
  );
}
...
//# sourceMappingURL=index-DmJEQlYM.js.map
