...
import { u as x } from "./useForm-DbBlZvmr.js";
const B = w({
  ...
  setup(_) {
    const n = c(""),
      ...
      i = b(),
      o = () => {
        d.validate() && i.push({ name: "recover-password-email" });
      };
    return (g, e) => {
      const p = a("VaInput"),
        l = a("VaButton"),
      ...
      return (
        ...
        V(
          f,
          { ref: "passwordForm", onSubmit: v(o, ["prevent"]) },
          {
            default: t(() => [
              e[3] ||
                (e[3] = m(
              ...
              r(
                ...
                {
                  default: t(() => e[1] || (e[1] = [u("Send password")])),
                  _: 1,
                },
              ),
              r(
                ...
                { default: t(() => e[2] || (e[2] = [u("Go back")])), _: 1 },
              ),
            ]),
            _: 1,
          },
...
export { B as default };
//# sourceMappingURL=RecoverPassword-DekNwEnR.js.map
